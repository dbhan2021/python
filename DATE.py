...
while date !="q":
    ...
    if  date == "q":
        ...
        if yyyy < 1900 or yyyy > 2099:
                print(" Invalid Entry - Enter Year between 1900 and 2099")
                continue
        if mm < 1 or mm > 12:
                print("Invalid Entry -  Enter Month between 1 and 12")
                continue
        if dd < 1 or dd > 31:
                print("Invalid Entry - Enter Day between 1 and 31")
                continue   
        last2digits = abs(yyyy)%1000
